...
console.log('- GITHUB_CLIENT_ID value:', env.GITHUB_CLIENT_ID);
console.log('- GITHUB_CLIENT_SECRET exists:', !!env.GITHUB_CLIENT_SECRET);
console.log('- GITHUB_CLIENT_SECRET value:', env.GITHUB_CLIENT_SECRET);
console.log('- GITHUB_CLIENT_REDIRECT_URI exists:', !!env.GITHUB_CLIENT_REDIRECT_URI);
console.log('- GITHUB_CLIENT_REDIRECT_URI value:', env.GITHUB_CLIENT_REDIRECT_URI);
